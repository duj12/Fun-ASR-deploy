...
class FsmnVADStreaming(nn.Module):
    ...
    def init_cache(self, cache: dict = {}, **kwargs):
        ...
        if kwargs.get("max_single_segment_time") is not None:
            # update the max_single_segment_time
            self.vad_opts.max_single_segment_time = kwargs.get("max_single_segment_time")
        if kwargs.get("decibel_thres") is not None:
            # update the decibel_thres
            self.vad_opts.decibel_thres = kwargs.get("decibel_thres")
